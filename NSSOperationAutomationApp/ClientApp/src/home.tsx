...
class SentimentAnalysisPage extends React.Component<ISearchContentProps, MyState> {
    ...
    render() {
        ...
        return (
            ...
            <div>
                <div className="headerdiv mb-3">
                    <img src={embeelogo} alt='filter' style={{ height: "32px", margin: "6px" }} />

                </div>
                <div className="bodyContainer">
                    <div className='col-sm-6 leftPart'>
                        <div style={{ width: "85%" }}>
                            <Text content="Sentiment Analysis" weight="bold" className="title" />
                            <div style={{ marginBottom: "10px" }}>
                                <Text content="from Call Recordings with" weight="bold" className="subtitle" /><Text content=" AI" weight="bold" className="subtitle redTag" color='Red' />
                            </div>
                            <Text className="description" content="Experience seamless sentiment analysis with our web application designed for call recording uploads. Harnessing the power of open API technology, our platform swiftly analyzes the sentiment of your recordings, providing valuable insights for enhanced communication strategies and customer satisfaction." />
                            <div className='mt_15'>
                                <Input type="file" id="upload" style={{ display: 'none' }} onChange={(value: any) => this.documentUploadFnc(value)} ></Input>
                                <div className="pointer" onClick={() => this.fileUpload()} > <img src={buttonimg} alt='filter' /></div>
                            </div>
                            {this.state.loading ? <div className='loaderdiv'>
                            <Loader label="Uploading files and sentiment analysis is being performed" />
                        </div> : <div className='responseBody'>

                            <Text content={this.state.searchResponse} style={{fontSize:"20px"}}/>
