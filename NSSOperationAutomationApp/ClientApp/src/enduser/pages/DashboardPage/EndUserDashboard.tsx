...
import { getCallStatusMasterAPI, getAdminTicketList } from '../../../apis/APIList'

import "./../../../App.scss";
import "./EndUserDashboard.scss";
...
class EnduserTicketList extends React.Component<IDashboardProps, MyState>{
    ...
    componentDidMount() {
        ...
        microsoftTeams.getContext((context) => {
            ...
            this.setState({
                assignedTo:context.userPrincipalName && context.userPrincipalName,
            },()=>{
                this.search()
            })
        });
        console.log('In enduser TicketList');
    ...
    search = () => {
        const data = {
            ...
            "assignedTo": null,
            "assignedToEmail": this.state.assignedTo,
            "isAssigned": null,
            "callStatusId": this.state.casestatus ? this.state.casestatus : null,
            "callActionId": null,
            "IsTimelineView": null
        }
    ...
    getAllTickets = (data: any) => {
        getAdminTicketList(data).then(response => {
            console.log('In getTicketList', response);
            if (response.data) {
    ...
    updateTicket = (item: any) => {
        ...
        let taskInfo: ITaskInfo = {
            url: `${base_URL}/detailticketenduser?id=${item.caseNumber}`,
            title: "Details View",
            height: 750,
            width: 1050,
            fallbackUrl: `${base_URL}/detailticketenduser?id=${item.caseNumber}`
        }
