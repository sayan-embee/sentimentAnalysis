...
GO
PRINT N'Dropping Procedure [dbo].[usp_AssignReassignTicket_CardResponse_Insert]...';


GO
DROP PROCEDURE [dbo].[usp_AssignReassignTicket_CardResponse_Insert];


GO
PRINT N'Dropping User-Defined Table Type [dbo].[udt_T_CardNotificationResponse]...';


GO
DROP TYPE [dbo].[udt_T_CardNotificationResponse];
...
GO
PRINT N'Altering Table [dbo].[T_CardNotificationResponse]...';


GO
ALTER TABLE [dbo].[T_CardNotificationResponse]
    ADD [Status] BIT NULL;
