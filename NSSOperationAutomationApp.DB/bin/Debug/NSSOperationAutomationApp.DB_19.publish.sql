...
BEGIN
	...
	-----------------
		...
		WHERE udt.CaseNumber NOT IN (SELECT CaseNumber FROM @DuplicateTicketTbl)
		...
		AND udt.CaseNumber NOT IN (SELECT CaseNumber FROM @DuplicateTicketTbl);
		...
		INSERT INTO dbo.[T_EngineerAssignmentHistory]
			...
			AND A.CaseNumber NOT IN (SELECT CaseNumber FROM @DuplicateTicketTbl);
		...
		AND TD.CaseNumber NOT IN (SELECT CaseNumber FROM @DuplicateTicketTbl);
